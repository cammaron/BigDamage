...
Grab the [latest release of BigDamage](/cammaron/BigDamage/releases) and place it in the BepInEx/plugins folder (if it doesn't exist yet, feel free to create it)
